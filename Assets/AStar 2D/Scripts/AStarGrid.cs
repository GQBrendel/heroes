...
namespace AStar_2D
{
    ...
    public class AStarGrid<T> : AStarAbstractGrid where T : SearchGrid, new()
    {
        ...
        /// <param name="callback">The <see cref="MonoDelegate"/> to invoke when the algorithm has completed</param>
        public override void findPath(Index start, Index end, DiagonalMode diagonal, MonoDelegate callback)
        {
            // Call through
        ...
        public override void findPath(Index start, Index end, DiagonalMode diagonal, PathRequestDelegate callback)
        {
            // Make sure the grid is ready
