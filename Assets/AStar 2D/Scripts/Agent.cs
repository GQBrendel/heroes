...
namespace AStar_2D
{
    ...
    /// </summary>
    public class Agent : MonoBehaviour, IDynamicObstacle
    {
        // Private
        ...
        /// <summary>
        /// Should the agent be considered as an obstacle. If so, the current node occupied by the agent will be considered unwalkable.
        /// </summary>
        public bool dynamicObstacle = true;
        ...
        /// <summary>
        /// <see cref="IDynamicObstacle"/> implementation. 
        /// </summary>
        ...
        public IEnumerable<Index> occupiedIndexes()
        {
